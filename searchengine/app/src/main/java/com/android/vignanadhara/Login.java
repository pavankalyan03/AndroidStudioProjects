            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    if (passwordFromDB.equals(userPassword)) {
                        ...
                        prefs.edit().putString("gender", genderFromDB).apply();
                        prefs.edit().putString("email", emailFromDB).apply();
                        prefs.edit().putString("username", usernameFromDB).apply();
                        prefs.edit().putString("password", passwordFromDB).apply();
                        prefs.edit().putString("location", locationFromDB).apply();

                        Intent search = new Intent(Login.this, MainActivity.class);
